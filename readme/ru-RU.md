...
- **Системная интеграция:** `tauri-plugin-dialog`, `tauri-plugin-fs`, API оконных эффектов Tauri (`tauri::window::set_effects`)
...
- **Типографика:** Archivo (встроенный), Loskeley Mono (встроенный)
