...
>
	<input
		...
		{disabled}
		class={cn(
			'flex w-full px-3 py-1.5 text-[10px] font-semibold transition-colors placeholder:text-gray-alpha-600 focus-visible:border-blue-600! focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
			className
		)}
