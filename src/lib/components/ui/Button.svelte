<script lang="ts">
	...
	const buttonVariants = cva(
		'inline-flex items-center justify-center whitespace-nowrap rounded-sm text-[10px] font-medium tracking-wide transition-all disabled:pointer-events-none disabled:transition-none',
		{
			variants: {
				variant: {
					default:
