...
<div
	...
	class={cn(
		"group relative flex h-10 items-center px-4 transition-colors after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-gray-alpha-100 after:content-['']",
