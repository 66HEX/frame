		...
		{#if activeView === 'dashboard'}
			<div class="grid h-full grid-cols-12 gap-4">
				<div class="col-span-8 h-full min-h-0">
					<div class="grid h-full grid-rows-12 gap-4">
						<div class="row-span-8 min-h-0">
							...
							{:else}
								<div
									class="card-highlight flex h-full flex-col items-center justify-center overflow-hidden rounded-lg bg-gray-alpha-100"
								></div>
							{/if}
						</div>
				...
				<div class="col-span-4 h-full min-h-0">
					<div class="card-highlight h-full min-h-0 rounded-lg bg-gray-alpha-100">
	...
	{#if isDragging}
		...
		>
			<div
				...
				class="card-highlight flex h-36 w-72 flex-col items-center justify-center rounded-lg bg-sidebar"
			>
